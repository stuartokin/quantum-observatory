...
metrics:
  ...
  - name: Logical qubits for ECC-256
    value: '1193'
    unit: logical qubits
    note: 'Chevignard/Fouque/Schrottenloher EUROCRYPT 2026 (ePrint 2026/280). Width-optimised; high gate count. Luo et al. arXiv:2607.13816 claims further reduction to 835 logical qubits but at ~20x more Toffoli gates; not peer-reviewed.'
links:
  - to: crqc
...
evidence:
  ...
  sources:
    ...
    - url: https://arxiv.org/abs/2607.13816
      ...
      accessed: '2026-08-11'
      note: 'Luo et al. (Peking University / Tsinghua / CAS). Preprint, not peer-reviewed. Claims 835 logical qubits for ECC-256 at ~20x more Toffoli gates than Chevignard/Babbush. Width-optimised; depth tradeoff not yet analysed. Cites Chevignard P-256 as 1,098 — error per ePrint 2026/280 correction; correct P-256 is 1,193.'
confidence: high
status: published
origin: agent
added: '2026-08-08'
review:
  ...
  note: 'Gidney arXiv:2505.15917 re-confirmed as preprint-only via arXiv.org and ResearchGate. E3 correct. No peer-reviewed publication found. All other figures unchanged from prior run.'
---
