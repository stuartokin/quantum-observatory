...
review:
  ...
  note: 'Nature 638, 920-926 confirmed. Λ=2.14±0.02, 0.143%±0.003% per cycle, 2.4±0.3× break-even confirmed in prior run. This item and qec-below-threshold-surface-code share the same primary source; neither is a duplicate — one covers below-threshold milestone, this covers break-even metric specifically. E4 correct. No changes made.'
---
