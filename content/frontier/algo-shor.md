...
review:
  ...
  note: 'Babbush source note updated per 2026-08-16 decisions precedent: E3 confirmed, E2/E3 unsettled flag removed. Trail of Bits exploit confirmed as memory safety and logic vulnerabilities (not memory-safety only per blog.trailofbits.com). No other changes. All claims and evidence level hold.'
---
