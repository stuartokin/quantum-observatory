...
summary: A code family encoding twelve logical qubits in 288 physical qubits — roughly a tenfold overhead reduction against the surface code, and now the centre of IBM's fault-tolerance roadmap.
pillar: quantum
...
metrics:
  - name: Code parameters
    value: '[[144,12,12]]'
    note: the "gross" code — 144 data plus 144 syndrome qubits
